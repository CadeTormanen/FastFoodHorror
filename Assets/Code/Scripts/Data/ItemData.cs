...
public class ItemData : MonoBehaviour
{
    ...
    private Hashtable CreateItemMap()
    {
        ...
        map.Add("french_fry_raw", new Item("french_fry_raw", 1, 1,lettuceSprite, false, false,modelFryRaw));
        map.Add("french_fry_done",new Item("french_fry_done", 1, 1,lettuceSprite, false, false,modelFryCooked));
